  ...
  zh: {
    ...
    facts: {
      ...
      items: [
        ...
        { title: '源码可见', body: '源代码、开发过程与问题追踪可查阅。官方二进制通过 MoonSprite 授权渠道分发。' },
    ...
    faq: {
      ...
      items: [
        ...
        { q: '项目会收费吗？', a: '源码采用 MoonSprite Source-Available License；Steam 等授权渠道的官方二进制按用户授权，允许用于个人与商业创作。' },
      ],
    },
    cta: { eyebrow: '下一帧，即将开始', title: '关注 MoonSprite 的开发进度。', body: 'Steam 页面开放后即可加入愿望单。现在可以先在 GitHub 查看源代码、版本进展与已知问题。' },
    footer: { description: '原创源码可见 Windows 像素画工作台。', source: '源代码', license: '源码可见许可', notice: 'MoonSprite 与 Aseprite 无隶属关系。' },
  },
  en: {
