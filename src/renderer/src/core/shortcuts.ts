...
export const SHORTCUT_GROUPS = {
  ...
  layers: ['newLayer', 'createLayerGroup', 'toggleClippingMask', 'duplicateLayer', 'mergeLayerDown', 'mergeSelectedLayers', 'mergeLayerGroup', 'mergeVisibleLayers', 'ungroupLayers', 'deleteLayer', 'toggleSelectionOutline'],
