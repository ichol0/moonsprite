...
export function CanvasStage({ session }: { session: DocumentSession }) {
  ...
  const drawSelectionOverlay = (): void => {
    ...
    const shouldDrawSelection = Boolean(visibleSelection || visibleTextBox || (selectionSizeVisible && selectionSizeTarget))
