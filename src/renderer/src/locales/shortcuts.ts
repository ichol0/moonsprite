...
const zhGroups: Record<ShortcutGroupId, string> = {
  file: '文件', edit: '编辑', selection: '选区', image: '图像', color: '颜色', layers: '图层', animation: '动画', view: '视图', interface: '界面与栏目', tools: '工具', modifiers: '工具修饰', help: '帮助'
}

const enGroups: Record<ShortcutGroupId, string> = {
  file: 'File', edit: 'Edit', selection: 'Selection', image: 'Image', color: 'Color', layers: 'Layers', animation: 'Animation', view: 'View', interface: 'Interface & Panels', tools: 'Tools', modifiers: 'Tool Modifiers', help: 'Help'
}
...
const zhLabels: Record<ShortcutId, string> = {
  ...
  copy: '复制', cut: '剪切', paste: '粘贴', pasteAsNewLayer: '粘贴为新图层', pasteAsNewDocument: '粘贴为新项目', save: '保存', saveAs: '另存为', undo: '撤销', redo: '重做', relativeLuminance: '查看相对明暗', advancedMode: '高级模式', fillForeground: '填充前景色', swapForegroundBackground: '交换前景色与背景色', replaceColor: '替换颜色', convertColorMode: '转换颜色模式', newLayer: '新建图层', createLayerGroup: '新建图层组', toggleSelectedLayerVisibility: '显示或隐藏所选图层', toggleSelectedLayerLock: '锁定或解锁所选图层', toggleSelectedGroupCollapsed: '展开或收起所选图层组', duplicateLayer: '复制图层', mergeLayerDown: '向下合并', mergeSelectedLayers: '合并所选图层', mergeLayerGroup: '合并图层组', mergeVisibleLayers: '合并可见图层', ungroupLayers: '解组', deleteLayer: '删除图层或选区', toggleSelectionOutline: '显示或隐藏蚂蚁线', mirrorView: '水平镜像视图', mirrorViewVertical: '垂直镜像视图', toggleGrid: '显示像素网格', toggleCustomGrid: '显示自定义网格', openGridSettings: '网格设置', rotateViewClockwise90: '顺时针旋转视图 90°', rotateViewCounterClockwise90: '逆时针旋转视图 90°', resetView: '复位视图', toggleColorPanel: '显示或隐藏颜色栏目', togglePalettePanel: '显示或隐藏调色板栏目', toggleLayersPanel: '显示或隐藏图层栏目', togglePreviewPanel: '显示或隐藏预览栏目', toggleTimeline: '显示或隐藏时间轴', toolRailLeft: '工具栏放到左侧', toolRailRight: '工具栏放到右侧', saveWorkspaceLayout: '保存为新工作区', openWorkspaceManager: '管理工作区', openComponentLibrary: '组件库', openLatestRelease: '更新日志', openRoadmap: '未来计划', openAbout: '关于 MoonSprite',
  brushSizeDecrease: '减小笔刷尺寸', brushSizeIncrease: '增大笔刷尺寸', temporaryEyedropper: '临时吸色', temporaryMove: '临时移动工具', copySelectionContent: '复制选区内容', copyLayerOnDrag: '拖动复制图层', constrainAxis: '水平或垂直约束', addToSelection: '加选', proportionalSelectionTransform: '选区固定比例缩放', integerSelectionScale: '选区整数倍缩放', snapSelectionRotation: '选区八方向旋转', snapViewRotation: '视图八方向旋转', resetViewRotation: '旋转视图临时复位', temporaryPan: '临时抓手', brushSizeAdjust: '拖动调整笔刷尺寸', brushSizeWheelAdjust: '滚轮调整笔刷尺寸', lineConnectionMode: '直线连接模式', constrainLineDirections: '约束直线方向'
}
...
const enLabels: Record<ShortcutId, string> = {
  ...
  copy: 'Copy', cut: 'Cut', paste: 'Paste', pasteAsNewLayer: 'Paste as New Layer', pasteAsNewDocument: 'Paste as New Project', save: 'Save', saveAs: 'Save As', undo: 'Undo', redo: 'Redo', relativeLuminance: 'Relative Luminance', advancedMode: 'Advanced Mode', fillForeground: 'Fill with Foreground Color', swapForegroundBackground: 'Swap Foreground and Background', replaceColor: 'Replace Color', convertColorMode: 'Convert Color Mode', newLayer: 'New Layer', createLayerGroup: 'New Layer Group', toggleSelectedLayerVisibility: 'Show or Hide Selected Layers', toggleSelectedLayerLock: 'Lock or Unlock Selected Layers', toggleSelectedGroupCollapsed: 'Expand or Collapse Selected Groups', duplicateLayer: 'Duplicate Layer', mergeLayerDown: 'Merge Down', mergeSelectedLayers: 'Merge Selected Layers', mergeLayerGroup: 'Merge Layer Group', mergeVisibleLayers: 'Merge Visible Layers', ungroupLayers: 'Ungroup', deleteLayer: 'Delete Layer or Selection', toggleSelectionOutline: 'Show or Hide Marching Ants', mirrorView: 'Mirror View Horizontally', mirrorViewVertical: 'Mirror View Vertically', toggleGrid: 'Show Pixel Grid', toggleCustomGrid: 'Show Custom Grid', openGridSettings: 'Grid Settings', rotateViewClockwise90: 'Rotate View 90° Clockwise', rotateViewCounterClockwise90: 'Rotate View 90° Counterclockwise', resetView: 'Reset View', toggleColorPanel: 'Show or Hide Color Panel', togglePalettePanel: 'Show or Hide Palette Panel', toggleLayersPanel: 'Show or Hide Layers Panel', togglePreviewPanel: 'Show or Hide Preview Panel', toggleTimeline: 'Show or Hide Timeline', toolRailLeft: 'Move Toolbar to Left', toolRailRight: 'Move Toolbar to Right', saveWorkspaceLayout: 'Save as New Workspace', openWorkspaceManager: 'Manage Workspaces', openComponentLibrary: 'Component Library', openLatestRelease: 'Release Notes', openRoadmap: 'Roadmap', openAbout: 'About MoonSprite',
  brushSizeDecrease: 'Decrease Brush Size', brushSizeIncrease: 'Increase Brush Size', temporaryEyedropper: 'Temporary Eyedropper', temporaryMove: 'Temporary Move Tool', copySelectionContent: 'Copy Selection Content', copyLayerOnDrag: 'Duplicate Layer While Dragging', constrainAxis: 'Constrain Horizontally or Vertically', addToSelection: 'Add to Selection', proportionalSelectionTransform: 'Proportional Selection Scale', integerSelectionScale: 'Integer Selection Scale', snapSelectionRotation: 'Snap Selection Rotation to 8 Directions', snapViewRotation: 'Snap View Rotation to 8 Directions', resetViewRotation: 'Temporarily Reset View Rotation', temporaryPan: 'Temporary Hand Tool', brushSizeAdjust: 'Drag to Adjust Brush Size', brushSizeWheelAdjust: 'Wheel to Adjust Brush Size', lineConnectionMode: 'Line Connection Mode', constrainLineDirections: 'Constrain Line Directions'
}
